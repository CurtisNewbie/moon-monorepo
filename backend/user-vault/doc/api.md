...
- JSON Response:
    ...
    - "msg": (string) message
    - "error": (bool) whether the request was successful
    - "data": (miso.PageRes[vault.UserInfo]) response data
...
- JSON Response:
    ...
    - "msg": (string) message
    - "error": (bool) whether the request was successful
    - "data": (miso.PageRes[repo.ListedAccessLog]) response data
      - "paging": (Paging) pagination parameters
        - "limit": (int) page limit
        - "page": (int) page number, 1-based
        - "total": (int) total count
...
- JSON Response:
    ...
    - "msg": (string) message
    - "error": (bool) whether the request was successful
    - "data": (miso.PageRes[vault.ListedUserKey]) response data
      - "paging": (Paging) pagination parameters
        - "limit": (int) page limit
        - "page": (int) page number, 1-based
        - "total": (int) total count
...
- JSON Response:
    ...
    - "msg": (string) message
    - "error": (bool) whether the request was successful
    - "data": (miso.PageRes[vault.ListSitePasswordRes]) response data
      - "paging": (Paging) pagination parameters
        - "limit": (int) page limit
        - "page": (int) page number, 1-based
        - "total": (int) total count
...
- JSON Response:
    ...
    - "msg": (string) message
    - "error": (bool) whether the request was successful
    - "data": (miso.PageRes[repo.Note]) response data
      - "paging": (Paging) pagination parameters
        - "limit": (int) page limit
        - "page": (int) page number, 1-based
        - "total": (int) total count
...
- JSON Response:
    ...
    - "msg": (string) message
    - "error": (bool) whether the request was successful
    - "data": (miso.PageRes[repo.ListedNotification]) response data
      - "paging": (Paging) pagination parameters
        - "limit": (int) page limit
        - "page": (int) page number, 1-based
        - "total": (int) total count
...
- AccessLogPipeline
  - RabbitMQ Queue: `event.bus.user-vault.access.log`
  - RabbitMQ Exchange: `event.bus.user-vault.access.log`
  - RabbitMQ RoutingKey: `#`
  - Event Payload:
    - "UserAgent": (string) 
    - "IpAddress": (string) 
