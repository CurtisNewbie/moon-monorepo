// auto generated by misoapi v0.2.16 at 2025/09/11 23:51:42 (CST), please do not modify
package web
...
func init() {
	...
	miso.HttpPost("/open/api/note/list-notes", miso.AutoHandler(
		func(inb *miso.Inbound, req vault.ListNoteReq) (miso.PageRes[vault.Note], error) {
	...
	miso.HttpPost("/open/api/note/save-note", miso.AutoHandler(
		func(inb *miso.Inbound, req vault.SaveNoteReq) (any, error) {
	...
	miso.HttpPost("/open/api/note/update-note", miso.AutoHandler(
		func(inb *miso.Inbound, req vault.UpdateNoteReq) (any, error) {
