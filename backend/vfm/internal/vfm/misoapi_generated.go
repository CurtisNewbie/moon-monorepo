// auto generated by misoapi v0.4.5 at 2025/12/10 01:16:06 (CST), please do not modify
package vfm
...
func init() {
	...
	miso.HttpPost("/internal/file/batch-fetch-info", miso.AutoHandler(
		func(inb *miso.Inbound, req InternalBatchFetchFileInfoReq) ([]InternalFetchFileInfoRes, error) {
	...
	miso.HttpPost("/internal/file/update-info", miso.AutoHandler(
		func(inb *miso.Inbound, req ApiInternalUpdateFileInfoReq) (any, error) {
			return nil, ApiInternalUpdateFileInfo(inb.Rail(), dbquery.GetDB(), req)
		})).
		Extra(miso.ExtraName, "ApiInternalUpdateFileInfo").
