// auto generated by misoapi v0.1.12 at 2024/12/09 11:46:58, please do not modify
package vfm
...
func init() {
	...
	miso.Post("/compensate/thumbnail",
		...
		Resource(ResCompensateMissingThumbnails)
	...
	miso.Post("/compensate/dir/calculate-size",
		...
		Resource(ResUpdateDirSizeEstimate)

	miso.Post("/compensate/regenerate-video-thumbnails",
		func(inb *miso.Inbound) (any, error) {
			return nil, RegenerateVideoThumbnailApi(inb.Rail(), mysql.GetMySQL())
		}).
		Desc("Regenerate video thumbnails").
		Resource(ResRegenerateVideoThumbnails)
	...
	miso.IPost("/history/record-browse-history",
		func(inb *miso.Inbound, req RecordBrowseHistoryReq) (any, error) {
			return nil, RecordBrowseHistoryApi(inb.Rail(), mysql.GetMySQL(), common.GetUser(inb.Rail()), req)
		}).
