// auto generated by misoapi v0.1.12-beta.2 at 2024/11/13 17:33:53, please do not modify
package vfm
...
func init() {
	...
	miso.IPost("/open/api/file/dir/tree",
		func(inb *miso.Inbound, req FetchDirTreeReq) (*DirTreeNode, error) {
			return FetchDirTreeEp(inb, mysql.NewQuery(mysql.GetMySQL()), req, common.GetUser(inb.Rail()))
		}).
		Desc("Fetch directory tree.").
		Resource(ManageFilesResource)
