...
CREATE TABLE `file_info` (
  ...
  `hidden` tinyint NOT NULL DEFAULT '0' COMMENT 'whether the file is hidden',
  PRIMARY KEY (`id`),
...
CREATE TABLE `versioned_file` (
  ...
  `size_in_bytes` bigint(20) NOT NULL COMMENT 'size in bytes',
...
CREATE TABLE `bookmark` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_user_no_md5` (`user_no`,`md5`),
  KEY `idx_name` (`name`)
